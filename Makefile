...
%.authors:
	...
	psql $(FTM_STORE_URI) -c "copy (select distinct fingerprint from author_triples where source = '$*') to stdout" | parallel -N1000 --pipe ftg db dedupe-fingerprints | parallel --pipe -N10000 ftg db insert author_aggregation
